...
LVE pozwala na edycję z dokładnością do klatki i GOP strumieni
elementarnych ("ES") oraz programowych ("PS") MPEG1/2, włącznie z
formatem VOB. Silnik obcinający jest oparty na serwerze ramek
(demuxerze), gwarantującym dokładne i szybkie przeskakiwanie do każdej
klatki. Interfejs graficzny oparty jest na libSDL. Sceny filmów można
tworzyć z lub bez ponownego kodowania. Dostępne są także narzędzia do
zmniejszania i składania DVD.
